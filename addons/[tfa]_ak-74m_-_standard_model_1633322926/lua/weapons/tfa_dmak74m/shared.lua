SWEP.Gun					= ("tfa_dmak74m") --Make sure this is unique.  Specically, your folder name.
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "Danger Armory" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "AK-74M - Standard Model"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("weapons/ak74m.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.DamageType = DMG_GENERIC --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.JumpRecoilMultiplier=3  --Multiply recoil by this factor when we're crouching.  This is proportional, not inversely.
...
SWEP.JumpAccuracyMultiplier=20--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
SWEP.WalkAccuracyMultiplier=10--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
...
SWEP.WeaponLength = 35 --Almost 3 feet Feet.  This should be how far the weapon sticks out from the player.  This is used for calculating the nearwall trace.
SWEP.MoveSpeed = 0.87 --Multiply the player's movespeed by this.
...
SWEP.ViewModel			= "models/weapons/v_tfa_dmak74m.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/w_tfa_dmak74m.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(-0.561, 0, 1.406) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-11.256, 20.402, 0) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-2.83, -5, 0.264) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably

--[[INSPECTION]]--

SWEP.InspectPos = Vector(5.627, -2.412, -1.206) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(22.513, 32.361, 7.738) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.ProceduralReloadTime = 3 --Procedural reload time?
